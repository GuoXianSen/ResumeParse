...
<!--                    </el-date-picker>-->
<!--                </el-form-item>-->
                <el-form-item label=""><el-button  @click="search" type="primary" icon="Search" v-show="isShowBtn('adminManage','人员管理','Search')">查询</el-button></el-form-item>
                <el-form-item label=""><el-button  @click="handleEdit('','reset')" icon="Refresh">重置</el-button></el-form-item>
                <el-form-item label=""><el-button  icon="Plus" @click="addAdmin" type="primary" v-show="isShowBtn('adminManage','人员管理','Create')">新增</el-button></el-form-item>
            </el-form>
        </div>
        ...
        <div class="table">
            <el-table  :height="'calc('+(tableHeight)+'px)'" border :data="tableData" ref="tableref" v-loading="loadingPage" style="width: 100%">
                ...
                <el-table-column label="操作" fixed="right" width="120">
                    ...
                    <template #default="scope">
                        <span class="table-operate-btn" @click="handleEdit(scope.row,'edit')" v-show="isShowBtn('adminManage','人员管理','Update')">编辑</span>
                        <span class="table-operate-btn" @click="handleEdit(scope.row,'delete')" v-show="isShowBtn('adminManage','人员管理','Delete')">删除</span>
                    </template>
                </el-table-column>
            </el-table>
        </div>
