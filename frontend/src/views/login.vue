<template>
    <div class="lyouters">
        ...
        <div class="login-config">
            <el-button :icon="siteThemeStore.siteTheme == 'dark'?'sunny':'moon'" circle type="info"
                       @click="setSiteTheme"></el-button>
                ...
                <template #dropdown>
                    <el-dropdown-menu>
                        <el-dropdown-item v-for="item in lang" :key="item.value" :command="item"
                                          :class="{'lydpselected':language==item.value}">{{item.name}}
                        </el-dropdown-item>
                    </el-dropdown-menu>
                </template>
            </el-dropdown>
        ...
        <div class="login-wrap box" :style="{'--animationState':animationState}">
            <el-form label-position="left" :model="ruleForm" :rules="rules" ref="ruleForm" label-width="0px"
                ...
                <el-form-item prop="username">
                    <el-input type="text" size="large" style="font-size: 16px" v-model.trim="ruleForm.username"
                              auto-complete="off" :placeholder="$t('login.loginAccount')" maxlength="60">
                        <template #prepend>
                            <el-icon :size="20">
                                <User/>
                            </el-icon>
                ...
                <el-form-item prop="password">
                    <el-input type="password" size="large" style="font-size: 16px" v-model.trim="ruleForm.password"
                              auto-complete="off" :placeholder="$t('login.loginPWD')" maxlength="60">
                        <template #prepend>
                            <el-icon :size="20">
                                <lock/>
                            </el-icon>
                ...
                <el-form-item prop="captcha">
                    <el-input type="text" size="large" style="font-size: 16px" v-model.trim="ruleForm.captcha"
                              auto-complete="off" @keyup.enter="submitForm('ruleForm')" :placeholder="$t('login.code')">
                        <template #prepend>
                            <el-icon :size="20">
                                <circle-check/>
                            </el-icon>
                ...
                <el-form-item style="width:100%">
                    <el-button type="primary" size="large" :loading="loadingLg" style="width:100%;font-size: 18px"
                               @click="submitForm('ruleForm')">{{$t('login.login')}}
                    </el-button>
                </el-form-item>
            </el-form>
        </div>
        <div class="login-copyright">
            Copyright © 2023 南邮智能简历系统团队 All rights reserved.
        </div>
    </div>
</template>
<script>
