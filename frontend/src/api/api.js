...
import {reqExpost,ajaxGet,ajaxPost,ajaxDelete,ajaxPut,ajaxPatch,uploadImg,uploadFile,ajaxGetDetailByID} from './request';
import {url} from './url';
 ...
 * */
// 简历管理 列表
export const CvsCvs= params => ajaxGet({url: `cv/cv/`,params})
// 简历管理 新增
export const CvsCvsAdd= params => ajaxPost({url: `cv/cv/`,params})
// 简历管理 编辑
export const CvsCvsEdit= params => ajaxPut({url: `cv/cv/`,params})
// 简历管理 删除
export const CvsCvsDelete= params => ajaxDelete({url: `cv/cv/`,params})
// 简历管理 禁用用户
export const CvsCvsdisableEdit= params => ajaxPut({url: `cv/cv/disableuser/`,params})
// 简历管理 导出
export const CvsCvsExportexecl= params => ajaxGet({url: `cv/cv/exportexecl/`,params})

/**
 *测试用 岗位管理 HR功能
 * */
// 岗位管理 列表
export const CvPostsCvPosts= params => ajaxGet({url: `cvpost/cvpost/`,params})
// 岗位管理 新增
export const CvPostsCvPostsAdd= params => ajaxPost({url: `cvpost/cvpost/`,params})
// 岗位管理 编辑
export const CvPostsCvPostsEdit= params => ajaxPut({url: `cvpost/cvpost/`,params})
// 岗位管理 删除
export const CvPostsCvPostsDelete= params => ajaxDelete({url: `cvpost/cvpost/`,params})
// 岗位管理 禁用用户
export const CvPostsCvPostsdisableEdit= params => ajaxPut({url: `cvpost/cvpost/disableuser/`,params})
// 岗位管理 导出
export const CvPostsCvPostsExportexecl= params => ajaxGet({url: `cvpost/cvpost/exportexecl/`,params})

/**
 *测试用 简历文件上传管理 用户and HR功能
 * */
// 简历上传管理 列表
export const CvUpload= params => ajaxGet({url: `cvupload/cvupload/`,params})
// 简历文件管理 新增
export const CvUploadAdd= params => ajaxPost({url: `cvupload/cvupload/`,params})
// 简历文件管理 编辑
export const CvUploadEdit= params => ajaxPut({url: `cvupload/cvupload/`,params})
// 简历文件管理 删除
export const CvUploadDelete= params => ajaxDelete({url: `cvupload/cvupload/`,params})
// 简历文件管理 禁用用户
export const CvUploaddisableEdit= params => ajaxPut({url: `cvupload/cvupload/disableuser/`,params})
// 简历文件管理 导出
export const CvUploadExportexecl= params => ajaxGet({url: `cvupload/cvupload/exportexecl/`,params})
...
// 平台设置 文件上传
export const platformsettingsUploadPlatformFile = (params,path) => uploadFile({url: `platformsettings/uploadplatformfile/`, params, path})
