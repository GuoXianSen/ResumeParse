...
class UserLeavingMessage(CoreModel):
    ...
    message_type = models.SmallIntegerField(default=1, choices=MESSAGE_CHOICES, verbose_name="留言类型",
...
class SystemConfig(CoreModel):
    ...
    parent = models.ForeignKey(to="self", verbose_name="父级", on_delete=models.CASCADE, db_constraint=False, null=True,
                               blank=True, help_text="父级")
    ...
    form_item_type = models.SmallIntegerField(choices=CHOICE_FORM_ITEM_TYPE_LIST, verbose_name="表单类型", help_text="表单类型",
